(function () {
  ...
  var GROUPS = [
    ...
    { title: 'کافی', icon: '☕', ids: ['coffee-espresso-single','coffee-espresso-double','coffee-americano','coffee-cappuccino','coffee-nescafe-milk','coffee-latte-biscuit','coffee-latte-macchiato','coffee-latte'] },
    ...
    { title: 'بار گرم', icon: '🥛', ids: ['hot-chocolate','hot-pink-chocolate','hot-hazelnut','hot-milk-biscuit','hot-milk-honey','hot-tea-brewed','hot-tea-masala','hot-tea-kork'] },
